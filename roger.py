...
list_of_errors["BOOL_VALUE"] = \
    "You need to return true or false.  Not 1 or 0."
...
def indentationStation(filename, clean_lines, line, line_num,
...
def parseCurrentLine(filename, clean_lines, line, line_num,
                     operator_space_tracker, rubric):
    ...
    indentationStation(filename, clean_lines, line, line_num, operator_space_tracker,
                       rubric) #TODO THIS IS UNDER CONSTRUCTION
